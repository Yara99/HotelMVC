...
namespace HotelMVC.Controllers
{
    public class UserloginsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Username,Userpassword,Userid,Roleid")] Userlogin userlogin)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Id,Username,Userpassword,Userid,Roleid")] Userlogin userlogin)
        {
            if (id != userlogin.Id)
            {
                return NotFound();
